...
class ExampleTriangle : public entry::AppI
{
public:
    ExampleTriangle(const char* _name, const char* _description, const char* _url)
    ...
    void init(int32_t _argc, const char* const* _argv, uint32_t _width, uint32_t _height) override
    {
        ...
        m_program = loadProgram("../../../hello_triangle/vs_triangle",
                                "../../../hello_triangle/fs_triangle");
